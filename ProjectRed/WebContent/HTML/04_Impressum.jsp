...
<header><h1> Impressum setupXpert.com </h1></header>
	<hr>
	<h2>1) Angaben gem. § 5 TMG:</h2>
	<p>
		Stefan Küspert <br> Maisbrunner Straße 1 <br> 85250
		Altomünster
	</p>
	<h2>2) Kontaktaufnahme</h2>
	<p>
		Telefon: 0176/993 938 43 <br>E-mail: wov1234@thi.de,
		isc1234@thi.de, stk5269@thi.de <br>
	</p>
	...
	<p>Eine diesbezügliche Haftung ist jedoch erst ab dem Zeitpunkt der
	...
	<p>Die auf unserer Webseite veröffentlichen Inhalte und Werke
